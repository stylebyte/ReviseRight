    ...
    <div class="container-fluid px-0">
        <div class="d-flex align-items-center justify-content-between px-4 py-4" style="background:lightblue;">
            ...
            <div class="d-flex align-items-center gap-3 ">
                <a href="index.html" class="btn px-4 py-2 fw-semibold" style="background-color:rgb(15, 0, 66);color:azure;">
                    LOGIN
                </a>
                <a href="register.html" class="btn px-4 py-2 fw-semibold" style="background-color:rgb(15, 0, 66);color:azure;">
                    REGISTER
                </a>
                <span class="border rounded-circle px-2 fw-bold"style="color:rgb(15, 0, 66);color:rgb(15, 0, 66)">?</span>
            </div>
        </div>
    ...
    <div class="container mt-5">
        <div class="row align-items-center">
            ...
            <div class="col-md-7 ps-md-5">
                ...
                <a href="register.html" class="btn btn-lg px-5 py-3 mb-3"
                    style="background:rgba(78, 223, 245, 0.614); color:#000; font-weight:600;">
